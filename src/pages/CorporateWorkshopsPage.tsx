...
const whyUs = [
  {
    ...
    desc: 'Step-by-step guidance from a Fevicryl-certified facilitator means every participant — from first-timer to secret artist — walks away proud of what they made.',
  },
  {
    title: 'Zero logistics on your end',
    desc: 'We bring every art supply, set up before the session, and clean up after. You only need to provide tables, chairs, and your team.',
  },
  {
    title: 'Every participant takes artwork home',
    desc: 'A physical takeaway that lasts long after the event — more memorable than a dinner or a quiz.',
  },
  {
    title: 'Flexible group sizes',
    desc: 'From intimate offsites of 20 to large annual days of 200+. Pricing scales accordingly with no compromise on quality.',
  },
  {
    title: 'Fully customisable to your theme',
    desc: 'Colour palettes, corporate branding, event themes — we align the activity to your occasion.',
  },
  {
    title: 'Online sessions pan-India',
    desc: 'Distributed teams are not a barrier. We ship materials and facilitate live online sessions across India.',
  },
];
...
const corporateFaqs = [
  {
    q: 'What makes art workshops better than other corporate team-building activities?',
    a: 'Unlike games or quizzes, art workshops produce a physical outcome every participant keeps. The shared creative process builds camaraderie without competition. Participants frequently describe the experience as genuinely therapeutic — a rare outcome from a corporate event.',
  },
  {
    q: 'Can you handle 100+ participants in a single session?',
    a: 'Yes — our large-group format is designed for 100 to 200+ participants. Pricing drops to ₹600 per person at this scale and we bring additional facilitators if required.',
  },
  {
    q: 'Which activity works best for corporate team building?',
    a: 'Lippan Art, Mandala Art, and Boho Canvas are our most requested for corporate groups. Tie & Dye works brilliantly for outdoor or high-energy events. We always recommend based on your group size, event tone, and duration available.',
  },
  {
    q: 'Can you incorporate our company branding or colours?',
    a: 'Absolutely. Tote Bag Painting and Canvas Pouch are particularly popular as branded gifting workshops. We can work with your brand palette and theme across most activities.',
  },
  {
    q: 'Do you conduct workshops on weekends or at off-site venues?',
    a: 'Yes — we conduct workshops any day of the week including weekends, at your office, a rented venue, hotel banquet hall, or outdoor space. We only need tables and chairs.',
  },
];
      ...
      <main className="pt-24 bg-brand-offwhite">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <h1 className="font-serif text-5xl md:text-6xl font-bold text-brand-slate leading-tight mb-6">
                  ...
                  <span className="text-brand-pink italic">Your Team Will Remember</span>
                </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-brand-slate mb-4">
                Why Teams <span className="text-brand-pink italic">Choose Kraftykinni</span>
              </h2>
              <div className="w-24 h-1 bg-brand-pink mx-auto rounded-full mb-6" />
              <p className="text-lg text-brand-slate/70 max-w-2xl mx-auto">
                We have conducted 50+ corporate workshops across Delhi NCR. Here is what makes the difference.
              </p>
            </div>
        ...
        <section id="activities" className="py-24 bg-brand-offwhite">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-brand-slate mb-4">
                13 Signature <span className="text-brand-pink italic">Workshop Activities</span>
              </h2>
              <div className="w-24 h-1 bg-brand-pink mx-auto rounded-full mb-6" />
              <p className="text-lg text-brand-slate/70 max-w-2xl mx-auto">
                Each activity is self-contained, fully facilitated, and results in a takeaway. Click any activity to learn more.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {workshopsData.map((w, i) => (
                ...
                >
                  <Link
                    to={`/workshops/${w.id}`}
                    className="group block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100"
                  >
                    <div className="aspect-[4/3] overflow-hidden relative">
                      <img
                        src={w.image}
                        alt={`${w.title} corporate workshop Delhi NCR`}
        ...
        {/* ── Pricing — reuse existing PricingFAQ, swapping its FAQ with corporate-specific ones ── */}

...
// ── Location data — unique copy, keywords, and landmarks per city ──
const locationData = {
  delhi: {
    ...
    keywords: 'art workshop in Delhi, DIY workshop Delhi, creative workshop Delhi, corporate art workshop Delhi, craft class Delhi, team building art Delhi, art session Delhi',
    ...
    corporateLink: '/corporate-art-workshops',
    localSchema: {
  ...
  gurgaon: {
    ...
    keywords: 'art workshop Gurgaon, corporate art workshop Gurgaon, team building workshop Gurgaon, creative workshop Gurgaon Gurugram, DIY workshop Gurugram, art class Gurgaon corporate',
...
export default function LocationPage() {
  ...
  const schema = {
    ...
    address: {
      '@type': 'PostalAddress',
      addressLocality: loc.localSchema.addressLocality,
      addressRegion: loc.localSchema.addressRegion,
      postalCode: loc.localSchema.postalCode,
      addressCountry: 'IN',
    },
    ...
    <>
      ...
      <main className="pt-24 bg-brand-offwhite">
        ...
        <section className="py-16 bg-brand-offwhite relative overflow-hidden">
          <div className="absolute top-0 right-0 w-1/3 h-full bg-brand-pink/3 blur-3xl -z-10" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-600 font-light mb-8">
              We travel to your office, school, or event venue. If your area is not listed, reach out — we cover all of {loc.city}.
            </p>
            <div className="flex flex-wrap gap-3">
              {loc.areas.map((area) => (
                <span
                  key={area}
                  className="px-5 py-2.5 bg-brand-offwhite text-brand-charcoal rounded-full border border-gray-200 text-sm font-medium"
                >
                  <MapPin size={13} className="inline text-brand-pink mr-1.5" />
                  {area}
                </span>
              ))}
            </div>
        ...
        <section className="py-24 bg-brand-offwhite">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-brand-slate/70 max-w-2xl mx-auto">
                All 13 of our signature workshop activities are available in {loc.city}. Click any activity to learn more about it.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {workshopsData.map((w, i) => (
                ...
                >
                  <Link
                    to={`/workshops/${w.id}`}
                    className="group block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-gray-100"
                  >
                    <div className="aspect-[4/3] overflow-hidden">
                      <img
                        src={w.image}
                        alt={`${w.title} workshop in ${loc.city}`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Our facilitator Shramita Govil is a Fevicryl-certified artist with 50+ workshops and 1,500+ participants across Delhi NCR. Every session is guided, stress-free, and ends with participants genuinely proud of what they created.
                </p>
              </div>

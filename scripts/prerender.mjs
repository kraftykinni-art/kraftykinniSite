...
function parseWorkshopsData() {
  ...
  for (const chunk of chunks) {
    ...
    byId[id] = { title, benefits, faq, howToSteps };
  }
  return byId;
}

const WORKSHOPS_DATA = parseWorkshopsData();
// Single source for "N workshop activities" copy sitewide — keeps every
// hardcoded mention in sync with workshops.ts instead of drifting (as the
// old literal "13" did once Wall & Rope Art and later workshops were added).
const TOTAL_WORKSHOPS = Object.keys(WORKSHOPS_DATA).length;
    ...
    bodyContent: `
      ...
      <section id="quick-facts">
        ...
        <ul>
          ...
          <li><strong>Activities:</strong> ${TOTAL_WORKSHOPS} signature workshop formats</li>
...
City: Delhi / Gurgaon / Noida</code></pre>
      ...
      <section id="faq">
        ...
        <details>
          ...
          <p>No — every session is guided step-by-step by Shramita Govil, a Fevicryl Certified Artist, so no prior art experience is needed. Across 50+ workshops and 1,500+ participants, everyone from complete beginners to confident hobbyists has left with a finished piece they are proud of.</p>
        </details>
        <details>
          <summary>What is the minimum group size?</summary>
          <p>Kraftykinni typically works with groups of 20 up to 200+ participants, covering corporate offsites, school assemblies, and private events of any scale. For smaller gatherings below 20, reach out directly via WhatsApp or the contact form and Shramita will do her best to accommodate.</p>
        </details>
        <details>
          <summary>Do you provide all the materials?</summary>
          <p>Yes. Every art supply is included in the ₹600–₹800 per-person price — paints, canvases, brushes, aprons, and activity-specific materials such as clay, mirrors, or fabric for tie-dye. You only need to provide tables and chairs; Kraftykinni brings everything else and handles cleanup afterward.</p>
        </details>
        <details>
          <summary>Where do you conduct workshops?</summary>
          <p>In person across <a href="/workshops-in-delhi">Delhi</a>, <a href="/workshops-in-gurgaon">Gurgaon</a>, and <a href="/workshops-in-noida">Noida</a> — at corporate offices, schools, colleges, and private venues such as homes or event spaces. Kraftykinni also runs live online workshops pan-India, shipping all materials directly to each participant before the session so remote teams can join in.</p>
        </details>
        <details>
          <summary>What are the payment and booking terms?</summary>
          <p>Seven days' advance notice is required to arrange materials and facilitators, along with a 50% deposit to confirm the date. The remaining balance is due on the day of the session. UPI, bank transfer, or cash are all accepted, and Shramita typically confirms availability within 24 hours.</p>
        </details>
      </section>

      <section id="who-its-for">
        <h2>Is Kraftykinni right for your event?</h2>
        <p>Kraftykinni works well for three kinds of hosts: <a href="/corporate-art-workshops">corporate teams</a> planning an offsite or annual day, <a href="/school-art-workshops">schools</a> running an art day or fest, and <a href="/private-art-workshops">private hosts</a> organising a birthday, kitty party, or baby shower. Meanwhile, if none of the ${TOTAL_WORKSHOPS} activities above stands out yet, try the <a href="/about">About page</a> for more on Shramita's background, or browse recent write-ups on the <a href="/blog">blog</a> for real event examples.</p>
      </section>

      <section id="summary">
        <h2>Key Takeaways</h2>
        <ul>
          <li>${TOTAL_WORKSHOPS} guided art workshops across Delhi, Gurgaon, and Noida, from ₹600 per person</li>
  ...
  // ── Corporate workshops ──────────────────────────────────────────────────
  {
    ...
    bodyContent: `
      ...
      <h2>${TOTAL_WORKSHOPS} Signature Workshop Activities</h2>
      ...
      <h2>Key Takeaways</h2>
      <ul>
        <li>${TOTAL_WORKSHOPS} guided art activities for teams of 20 to 200+, all materials included</li>
        <li>₹600–₹800 per person, depending on group size</li>
        <li>In person across Delhi, Gurgaon, and Noida, or online pan-India</li>
        <li>7 days' notice and a 50% deposit confirm a date</li>
      </ul>
    `,
  },
  ...
  // ── School workshops ─────────────────────────────────────────────────────
  {
    ...
    schemas: [
      {
        ...
        step: [
          { '@type': 'HowToStep', position: 1, name: 'Choose an activity', text: `Browse the ${TOTAL_WORKSHOPS} Kraftykinni signature activities and shortlist 2–3 that match your student age group and event theme.` },
    ...
    bodyContent: `
      ...
      <p>All ${TOTAL_WORKSHOPS} Kraftykinni signature activities are available for college groups. Lippan Art and Boho Canvas are particularly popular for fest events and orientation days.</p>
      ...
      <blockquote cite="https://www.google.com/maps/place/KraftyKinni/@28.5032749,77.3817466,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce9fb49d4e935:0xbed5ad5b5362b002!8m2!3d28.5032702!4d77.3843215!16s%2Fg%2F11svwnn70v">
        ...
        <cite>— Aparajita, Google review</cite>
      </blockquote>
      <h2>Key Takeaways</h2>
      <ul>
        <li>Groups from 30 students up to full school assemblies of 300+</li>
        <li>₹600–₹800 per student, all materials included, facilitator travels to your school</li>
        <li>Activities recommended by grade group, from primary through college</li>
        <li>CBSE and ICSE curriculum links available on request</li>
      </ul>
    `,
  },
  ...
  // ── Private art workshops ─────────────────────────────────────────────────
  {
    ...
    bodyContent: `
      ...
      <h2>Key Takeaways</h2>
      <ul>
        <li>Birthdays, kitty parties, bachelorettes, and baby showers across Delhi NCR</li>
        <li>Groups from 10 to 80+ guests, ₹600–₹800 per person, all materials included</li>
        <li>Kraftykinni travels to your home, a café, or a rented venue</li>
        <li>No experience needed — every guest leaves with a finished piece</li>
      </ul>
    `,
  },
  ...
  // ── About ────────────────────────────────────────────────────────────────
  {
    ...
    bodyContent: `
      ...
      <p>Today, Kraftykinni operates across Delhi, Gurgaon, and Noida with ${TOTAL_WORKSHOPS} signature activities and a growing roster of repeat clients including corporate teams, schools, universities, and private event organisers.</p>
      ...
      <p>The Fevicryl certification is issued by <a href="https://www.pidilite.com/consumer-brands/fevicryl" rel="noopener">Pidilite Industries</a>, the maker of the craft materials used across Kraftykinni sessions.</p>
      ...
      <h2>Service Area</h2>
      <p>Kraftykinni conducts in-person workshops across Delhi, Gurgaon, and Noida. Online workshops are available pan-India with materials shipped directly to participants. All ${TOTAL_WORKSHOPS} signature activities are available for corporate bookings, school programmes, college events, and private occasions.</p>
      <h2>What Past Participants Say</h2>
      <blockquote cite="https://www.google.com/maps/place/KraftyKinni/@28.5032749,77.3817466,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce9fb49d4e935:0xbed5ad5b5362b002!8m2!3d28.5032702!4d77.3843215!16s%2Fg%2F11svwnn70v">
        <p>"This workshop felt like therapy! Working with clay was incredibly soothing, and the environment was so positive. It's a great way to unwind and reconnect with your creative side."</p>
        <cite>— Navneet Arya, Google review</cite>
      </blockquote>
      <h2>Key Takeaways</h2>
      <ul>
        <li>Fevicryl Certified Artist with 50+ workshops conducted across Delhi NCR</li>
        <li>1,500+ participants trained across corporate, school, university, and private settings</li>
        <li>Regular facilitator at Amity University, Delhi and Noida campuses</li>
        <li>Available in person across Delhi, Gurgaon, and Noida, and online pan-India</li>
      </ul>
    `,
  },
  ...
  // ── Blog ─────────────────────────────────────────────────────────────────
  {
    ...
    bodyContent: `
      ...
      <p>Posts are grouped into four areas: Corporate, School &amp; College, Private Events, and Workshop Guides.</p>
      <h2>All Posts</h2>
      ${blogIndexListHtml()}
    `,
  },
  ...
  },
  {
    ...
    bodyContent: `<h1>Bottle Lamp Art Workshop in Delhi NCR</h1><p>Bottle Lamp Art is one of our most magical workshops — participants paint and decorate glass bottles, which are then fitted with fairy lights to create glowing home décor pieces. It blends sustainability through upcycling, creativity, and a deeply satisfying result. When the lights come on at the end of the session, the room transforms.</p><p>Turning a used bottle into a lamp is a small-scale example of <a href="https://en.wikipedia.org/wiki/Upcycling" rel="noopener">upcycling</a> — transforming a waste item into something of higher value rather than discarding it.</p><h2>What you make</h2><p>A hand-painted glass bottle lamp with fairy lights — a glowing, functional piece of home décor.</p><h2>Who it is for</h2><p>Great for corporate gifting events, school craft days, private parties, and eco-themed corporate events. Duration: 1.5 to 2 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('bottle-lamp-art')}`,
  },
  {
    ...
    bodyContent: `<h1>Block Printing Workshop in Delhi NCR</h1>
      ...
      <p>Globally, the wider craft of <a href="https://en.wikipedia.org/wiki/Woodblock_printing" rel="noopener">woodblock printing</a> is documented as one of the oldest textile and print techniques, used across Asia and Europe long before it became a defining feature of Rajasthani textile tradition.</p>
      <h2>What You Make</h2>
      ...
      <p>Block Printing is one of ${TOTAL_WORKSHOPS} activities available through Kraftykinni's <a href="/corporate-art-workshops/">corporate art workshop</a> programme. It is particularly popular for India Heritage Day events, cultural immersion programmes, and sustainability-themed corporate days.</p>
      <h2>Frequently Asked Questions</h2>
  ...
  },
  {
    ...
    bodyContent: `<h1>Wall Rope Art Workshop in Delhi NCR</h1><p>Wall Rope Art is one of our most visually striking workshops — participants coil natural cotton rope into circular forms and paint them with earthy botanical motifs, sunrise scenes, and boho-inspired designs that become show-stopping wall décor. The combination of tactile rope-work and freehand painting makes it uniquely satisfying: part sculpture, part canvas. Every piece is different, and every participant walks away genuinely surprised by what they have created.</p><p>The rope-coiling technique is related to <a href="https://en.wikipedia.org/wiki/Macram%C3%A9" rel="noopener">macramé</a>, a centuries-old knotting craft traditionally used for wall hangings, plant holders, and home décor.</p><h2>What you make</h2><p>A hand-coiled rope wall hanging painted with earthy botanical and boho motifs — unique, display-ready home décor.</p><h2>Who it is for</h2><p>Ideal for corporate team-building events, school art days, private parties, and bachelorette events where a distinctive, Instagram-worthy takeaway is desired. Duration: 2 to 2.5 hours. Groups from 20 to 200+. All materials included. Pricing from ₹600 per person.</p><h2>Why this activity works for corporate teams</h2><p>The two-stage process — coiling then painting — keeps participants engaged for the full session. The coiling phase is meditative and collaborative; the painting phase is expressive and personal. No two finished pieces look the same, which sparks genuine conversation and creative pride across the group.</p><h2>Frequently Asked Questions</h2><h3>What is Wall Rope Art?</h3><p>Wall Rope Art is a craft technique where natural cotton rope is coiled and glued into a circular form, then painted with earthy colours, botanical motifs, and boho-inspired designs. The finished piece is a unique wall hanging that combines the texture of natural rope with hand-painted artwork.</p><h3>Do I need any art experience to participate?</h3><p>No experience is required. Shramita guides participants through the coiling technique and the painting process step by step. The rope provides a natural, forgiving surface to paint on — even participants who consider themselves non-artists consistently produce beautiful results.</p><h3>How long does a Wall Rope Art workshop take?</h3><p>A Wall Rope Art session runs for 2 to 2.5 hours, including a demonstration of the coiling technique, guided painting of botanical and boho motifs, a drying period, and fitting of the jute hanging cord so the piece is ready to display immediately.</p>`,
  },

  // ── Botanical Dyeing Printing ────────────────────────────────────────────
  {
    path: '/workshops/botanical-dyeing-printing',
    title: 'Botanical Dyeing Printing Workshop Delhi NCR | Kraftykinni',
    description: 'Botanical Dyeing Printing workshop in Delhi NCR. Hammer real flowers onto fabric or paper for a one-of-a-kind keepsake. All materials included. ₹600–₹800/person.',
    h1: 'Botanical Dyeing Printing Workshop in Delhi NCR',
    bodyContent: `<h1>Botanical Dyeing Printing Workshop in Delhi NCR</h1><p>Botanical Dyeing Printing — also known as flower pounding or botanical hammer printing — transfers the real colour and shape of fresh flowers directly onto fabric or paper, with no paint involved. Participants arrange petals and leaves onto their surface, then gently hammer each one to release its natural pigment, leaving a delicate, one-of-a-kind print behind.</p><p>The technique of pressing flowers to preserve their colour and shape for decorative work dates back to 16th-century Japan, where it developed into the art form known as <a href="https://en.wikipedia.org/wiki/Oshibana" rel="noopener">oshibana</a>.</p><h2>What you make</h2><p>A hand-pressed botanical print on fabric or paper — made entirely from real flowers and leaves, unique and one-of-a-kind.</p><h2>Who it is for</h2><p>Ideal for private events, birthday parties, kitty parties, and corporate wellness or sustainability-themed days. Duration: 1.5 to 2 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('botanical-dyeing-printing')}`,
  },

  // ── Rock Painting ────────────────────────────────────────────────────────
  {
    path: '/workshops/rock-painting',
    title: 'Rock Painting Workshop Delhi NCR | Kraftykinni',
    description: 'Rock Painting workshop in Delhi NCR. Paint smooth stones into colourful mini landscapes and patterns. All materials included. ₹600–₹800/person.',
    h1: 'Rock Painting Workshop in Delhi NCR',
    bodyContent: `<h1>Rock Painting Workshop in Delhi NCR</h1><p>Rock Painting gives each participant a smooth stone and a set of acrylic paints, and asks for nothing more than a little focus. Popular designs range from miniature mountain-and-sunset landscapes to abstract dot patterns and geometric line work. Because the canvas is small, the activity moves quickly — most participants finish a first piece well within the hour.</p><h2>What you make</h2><p>One or more hand-painted decorative stones — mini landscape scenes, geometric patterns, or abstract designs, ready to display or gift.</p><h2>Who it is for</h2><p>Great for large school groups, quick corporate engagement sessions, kids' birthday parties, and any event where a fast, low-mess activity is needed. Duration: 1 to 1.5 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('rock-painting')}`,
  },

  // ── Umbrella Painting ────────────────────────────────────────────────────
  {
    path: '/workshops/umbrella-painting',
    title: 'Umbrella Painting Workshop Delhi NCR | Kraftykinni',
    description: 'Umbrella Painting workshop in Delhi NCR. Hand-paint a plain umbrella with florals or bold designs. All materials included. ₹600–₹800/person.',
    h1: 'Umbrella Painting Workshop in Delhi NCR',
    bodyContent: `<h1>Umbrella Painting Workshop in Delhi NCR</h1><p>Umbrella Painting hands participants a plain umbrella canopy and fabric paints, and lets them cover it edge to edge with florals, patterns, or bold freehand designs. The curved, panelled surface is larger and more forgiving than a canvas, so even a simple design reads as intentional once it wraps around the umbrella.</p><p>Materials include <a href="https://www.pidilite.com/consumer-brands/fevicryl" rel="noopener">Fevicryl</a> fabric colours, the certified product line Shramita Govil trained on.</p><h2>What you make</h2><p>A hand-painted fabric umbrella with a personalised floral or pattern design — genuinely usable and display-worthy.</p><h2>Who it is for</h2><p>A standout monsoon-season activity for private parties, corporate wellness days, and college fests. Duration: 2 to 2.5 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('umbrella-painting')}`,
  },

  // ── Cap Painting ─────────────────────────────────────────────────────────
  {
    path: '/workshops/cap-painting',
    title: 'Cap Painting Workshop Delhi NCR | Kraftykinni',
    description: 'Cap Painting workshop in Delhi NCR. Hand-paint a plain cap with florals or your own design. All materials included. ₹600–₹800/person.',
    h1: 'Cap Painting Workshop in Delhi NCR',
    bodyContent: `<h1>Cap Painting Workshop in Delhi NCR</h1><p>Cap Painting gives each participant a plain cotton cap and fabric paints to build a personalised design across the panel and brim — florals, lettering, abstract colour blocks, or a favourite motif. The compact surface keeps the session quick and focused, and the finished cap is something participants actually wear afterward.</p><p>Materials include <a href="https://www.pidilite.com/consumer-brands/fevicryl" rel="noopener">Fevicryl</a> fabric colours, the certified product line Shramita Govil trained on.</p><h2>What you make</h2><p>A hand-painted cotton cap with a personalised design — wearable, durable, and ready to use immediately.</p><h2>Who it is for</h2><p>Popular for college fests, corporate gifting days, birthday parties, and school craft sessions. Duration: 1.5 to 2 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('cap-painting')}`,
  },

  // ── Canvas Pearl Art ─────────────────────────────────────────────────────
  {
    path: '/workshops/canvas-pearl-art',
    title: 'Canvas Pearl Art Workshop Delhi NCR | Kraftykinni',
    description: 'Canvas Pearl Art workshop in Delhi NCR. Build radiating pearl patterns on a black canvas for an elegant wall piece. All materials included. ₹600–₹800/person.',
    h1: 'Canvas Pearl Art Workshop in Delhi NCR',
    bodyContent: `<h1>Canvas Pearl Art Workshop in Delhi NCR</h1><p>Canvas Pearl Art adapts the traditional string-and-nail technique — normally built with thread wound around pins — using pearls glued directly onto a black canvas instead. Participants build radiating, spiral, or symmetrical patterns one pearl at a time, working outward from a central point.</p><p>The technique draws on <a href="https://en.wikipedia.org/wiki/String_art" rel="noopener">string art</a>, where thread wound around a grid of points builds geometric patterns — this workshop swaps thread for pearls glued directly onto the canvas.</p><h2>What you make</h2><p>A hand-built canvas pearl art piece — an elegant, display-ready wall piece with a radiating or spiral pearl pattern on a black background.</p><h2>Who it is for</h2><p>A premium option for private events, corporate gifting, bridal showers, and anyone wanting a genuinely elegant keepsake activity. Duration: 2 to 2.5 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('canvas-pearl-art')}`,
  },

  // ── Clay Mirror Art ──────────────────────────────────────────────────────
  {
    path: '/workshops/clay-mirror-art',
    title: 'Clay Mirror Art Workshop Delhi NCR | Kraftykinni',
    description: 'Clay Mirror Art workshop in Delhi NCR. Sculpt a floral clay frame around a mirror for a genuinely usable keepsake. All materials included. ₹600–₹800/person.',
    h1: 'Clay Mirror Art Workshop in Delhi NCR',
    bodyContent: `<h1>Clay Mirror Art Workshop in Delhi NCR</h1><p>Clay Mirror Art gives each participant a small mirror and a set of air-dry clay to build an entirely hand-sculpted floral frame around it. Participants shape individual petals, leaves, and blooms, then arrange and press them around the mirror's edge one piece at a time. Unlike a purely decorative craft, the finished mirror is genuinely functional — something participants actually use at home, not just set on a shelf.</p><p>Hand-building and shaping clay is one of humanity's oldest crafts — <a href="https://en.wikipedia.org/wiki/Pottery" rel="noopener">pottery</a> dates back thousands of years and is still valued today for the same tactile, repetitive shaping process.</p><h2>What you make</h2><p>A hand-sculpted clay flower mirror frame — a genuinely usable mirror with a fully personalised floral border.</p><h2>Who it is for</h2><p>Ideal for private events, corporate gifting, school craft days, and anyone wanting a functional keepsake rather than a purely decorative one. Duration: 2 to 2.5 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('clay-mirror-art')}`,
  },

  // ── Mirror Painting ──────────────────────────────────────────────────────
  {
    path: '/workshops/mirror-painting',
    title: 'Mirror Painting Workshop Delhi NCR | Kraftykinni',
    description: 'Mirror Painting workshop in Delhi NCR. Hand-paint an illustrated scene directly onto a mirror for wall-ready décor. All materials included. ₹600–₹800/person.',
    h1: 'Mirror Painting Workshop in Delhi NCR',
    bodyContent: `<h1>Mirror Painting Workshop in Delhi NCR</h1><p>Mirror Painting has participants paint an illustrated scene — botanical motifs, woodland characters, or bold pattern work — directly onto the surface of a mirror using fine brushes and glass-safe paints. The reflective background behind the painted design gives even a simple illustration real visual depth, and the finished piece works equally well as a wall-mounted mirror or a piece of standalone décor.</p><p>The technique draws on <a href="https://en.wikipedia.org/wiki/Reverse_glass_painting" rel="noopener">reverse glass painting</a>, a centuries-old art form practised from Europe to India, prized for its glowing, translucent colour effect.</p><h2>What you make</h2><p>A hand-painted illustrated mirror — a wall-ready piece that is genuinely functional as well as decorative.</p><h2>Who it is for</h2><p>Great for private events, school art days, corporate gifting, and anyone wanting a decorative piece that doubles as a usable mirror. Duration: 1.5 to 2 hours. All materials included. Pricing from ₹600 per person.</p>${workshopFaqHtml('mirror-painting')}`,
  },
  ...
  // ── Employee Engagement Gurgaon ──────────────────────────────────────────
  {
    ...
    bodyContent: `
      ...
      <h2>What Past Participants Say</h2>
      <blockquote cite="https://www.google.com/maps/place/KraftyKinni/@28.5032749,77.3817466,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce9fb49d4e935:0xbed5ad5b5362b002!8m2!3d28.5032702!4d77.3843215!16s%2Fg%2F11svwnn70v">
        <p>"Such a cool and engaging workshop! The energy was great, and it kept me interested from start to finish. Would definitely join again."</p>
        <cite>— Daily Uplift, Google review</cite>
      </blockquote>
      <h2>Key Takeaways</h2>
      <ul>
        <li>Groups of 20 to 200+ at Gurgaon offices, ₹600–₹800 per person</li>
        <li>Popular for quarterly team days, appreciation days, onboarding, and annual days</li>
        <li>Lippan Art, Mandala Art, and Tie &amp; Dye are the most-requested activities</li>
        <li>All materials brought directly to DLF Cyber City, Udyog Vihar, and nearby offices</li>
      </ul>
    `,
  },
  ...
  // ── Location pages ────────────────────────────────────────────────────────
  {
    ...
    description: `Art workshops across Delhi for corporate teams, schools & private events. ${TOTAL_WORKSHOPS} activities, all materials included. Fevicryl-certified artist. ₹600–₹800/person.`,
    ...
    bodyContent: `<h1>Art Workshops in Delhi — Book a Session Today</h1>
      ...
      <h2>All ${TOTAL_WORKSHOPS} Activities Available in Delhi</h2>
      ...
      <p>All ${TOTAL_WORKSHOPS} Kraftykinni signature activities are available in Delhi: Lippan Art, Mandala Art, Tie &amp; Dye, Boho Canvas Art, Wall &amp; Rope Art, Block Printing, Clay Art, Glass Painting, Texture Art, Tote Bag Painting, Bottle Lamp Art, MDF Fridge Magnet, Trinket Tray Painting, Canvas Pouch Painting, Botanical Dyeing Printing, Rock Painting, Umbrella Painting, Cap Painting, Canvas Pearl Art, Clay Mirror Art, and Mirror Painting.</p>
      ...
      <h2>What Past Participants Say</h2>
      <blockquote cite="https://www.google.com/maps/place/KraftyKinni/@28.5032749,77.3817466,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce9fb49d4e935:0xbed5ad5b5362b002!8m2!3d28.5032702!4d77.3843215!16s%2Fg%2F11svwnn70v">
        <p>"Our students were completely engaged throughout the session. Shramita made it so easy and fun — even the shy kids opened up. We'd love to have Kraftykinni back again!"</p>
        <cite>— Shivani, Google review</cite>
      </blockquote>
      <h2>Key Takeaways</h2>
      <ul>
        <li>All ${TOTAL_WORKSHOPS} signature activities available across Delhi</li>
        <li>₹600–₹800 per person depending on group size, minimum 20 participants</li>
        <li>Covers Connaught Place, South Delhi, Dwarka, Rohini, Nehru Place, and more</li>
        <li>7 days' notice and a 50% deposit confirm your booking</li>
      </ul>`,
  },
  {
    path: '/workshops-in-gurgaon',
    title: 'Art Workshops in Gurgaon | Corporate Team Building | Kraftykinni',
    description: `Corporate art workshops and team-building in Gurgaon. Office visits, off-site events, school sessions. ${TOTAL_WORKSHOPS} activities, all materials included. ₹600–₹800/person.`,
    ...
    bodyContent: `<h1>Art Workshops in Gurgaon — For Corporate Teams and Events</h1>
      ...
      <h2>All ${TOTAL_WORKSHOPS} Activities Available in Gurgaon</h2>
      <p>Lippan Art, Mandala Art, Tie and Dye, Boho Canvas Art, Wall &amp; Rope Art, Bottle Lamp Art, Block Printing, Clay Art, Glass Painting, Texture Art, Tote Bag Painting, Trinket Tray Painting, MDF Fridge Magnet, Canvas Pouch Painting, Botanical Dyeing Printing, Rock Painting, Umbrella Painting, Cap Painting, Canvas Pearl Art, Clay Mirror Art, Mirror Painting.</p>
      ...
      <h2>What Past Participants Say</h2>
      <blockquote cite="https://www.google.com/maps/place/KraftyKinni/@28.5032749,77.3817466,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce9fb49d4e935:0xbed5ad5b5362b002!8m2!3d28.5032702!4d77.3843215!16s%2Fg%2F11svwnn70v">
        <p>"My child had a lovely experience at the magnet art workshop. Shramita is a lovely and humble host and children were really enjoying. Her skill set is worth appreciating."</p>
        <cite>— Rishabh Garg, Google review</cite>
      </blockquote>
      <h2>Key Takeaways</h2>
      <ul>
        <li>Covers DLF Cyber City, Udyog Vihar, MG Road, Golf Course Road, and Sohna Road</li>
        <li>₹600–₹800 per person, all materials included</li>
        <li>Lippan Art, Boho Canvas, Block Printing, and Mandala Art are top picks</li>
        <li>7 days' notice and a 50% deposit confirm a date</li>
      </ul>`,
  },
  {
    ...
    description: `Art workshops in Noida and Greater Noida for corporate teams, schools & private events. ${TOTAL_WORKSHOPS} activities, all materials included. ₹600–₹800/person.`,
    ...
    bodyContent: `<h1>Art Workshops in Noida — Corporate and School Sessions</h1>
      ...
      <h2>Key Takeaways</h2>
      <ul>
        <li>Covers Sector 62, Sector 16, Film City Road, Greater Noida, and Knowledge Park</li>
        <li>₹600–₹800 per person, minimum group size of 20</li>
        <li>Regular facilitator for Amity University student events</li>
        <li>7 days' notice and a 50% deposit confirm your booking</li>
      </ul>`,
  },
  ...
  {
    path: '/blog/trending-art-craft-workshops-delhi-ncr',
    title: "What's Trending in Art & Craft Workshops? | Kraftykinni",
    description: "What's trending in art and craft workshops in 2026 — personalization, mindful crafts, eco-friendly materials — from Kraftykinni's Delhi NCR sessions.",
    h1: "What's Trending in Art & Craft Workshops in Delhi NCR Right Now (2026)",
    schemas: [
      {
        '@context': 'https://schema.org',
        '@type': 'BlogPosting',
        'headline': "What's Trending in Art & Craft Workshops in Delhi NCR Right Now (2026)",
        'description': "What's trending in art and craft workshops in 2026 — personalization, mindful crafts, eco-friendly materials — from Kraftykinni's Delhi NCR sessions.",
        'url': 'https://kraftykinni.in/blog/trending-art-craft-workshops-delhi-ncr/',
        'datePublished': '2026-09-04',
        'dateModified': '2026-09-04',
        'author': { '@type': 'Person', 'name': 'Shramita Govil', 'url': 'https://kraftykinni.in/about/' },
        'publisher': { '@type': 'Organization', 'name': 'Kraftykinni', 'url': 'https://kraftykinni.in', 'logo': { '@type': 'ImageObject', 'url': 'https://cdn.kraftykinni.in/logo.jpeg' } },
        'mainEntityOfPage': { '@type': 'WebPage', '@id': 'https://kraftykinni.in/blog/trending-art-craft-workshops-delhi-ncr/' },
      },
    ],
    bodyContent: `<h1>What's Trending in Art & Craft Workshops in Delhi NCR Right Now (2026)</h1>
      <p>If you've searched for what's trending in art and craft lately, the honest answer isn't a single new craft — it's a shift in what people want the craft to do for them. Across the workshops Kraftykinni has run through 2026, three things keep repeating: participants want something personal, not generic; something slow, not another five-minute activity; and something made from materials that don't feel wasteful. Everything below comes from actual sessions Kraftykinni has run this year, not a trend report.</p>
      <h2>Personalization Has Replaced Generic Craft Kits</h2>
      <p>The single biggest shift this year has been away from "everyone paints the same template" toward pieces built around a specific person or relationship. For Friendship Day, Kraftykinni's MDF Fridge Magnet workshop turned into a personalized photo-magnet session — participants brought a photo of a friend and painted a magnet built around that exact picture. The same shift showed up for Raksha Bandhan, where siblings painted magnets referencing real in-jokes rather than a standard rakhi motif.</p>
      <h2>Slow, Meditative Crafts Are Winning Over Quick DIY</h2>
      <p>The second shift is toward activities that take genuine, unhurried time rather than another 20-minute craft. Dot Mandala Art is the clearest example — at a recent corporate session in Noida, a 20-person team spent an hour building symmetrical patterns one dot at a time at their own desks. There's no way to rush a dot mandala, and that's the point: it forces a real pause in a way a five-minute craft can't.</p>
      <h2>Eco-Conscious Materials Are Now a Default Expectation</h2>
      <p>A few years ago, "eco-friendly craft" was a request schools or CSR teams made specifically for Environment Day. In 2026, it's closer to a default expectation. Kraftykinni's Clay Art workshop now runs an eco-friendly clay Ganpati idol format for Ganesh Chaturthi — natural clay instead of Plaster of Paris, so the idol dissolves cleanly at visarjan instead of sitting in a landfill. The same instinct drives the upcycled bottle art sessions Kraftykinni runs through the year.</p>
      <h2>Heritage Indian Crafts Are Finding a Wider Audience</h2>
      <p>The third pattern is renewed interest in traditional Indian craft techniques — not as a museum topic, but as something people actually want to sit down and learn. Lippan Art, the mirror-inlay mud work that originates from Kutch, Gujarat, remains one of Kraftykinni's most-searched workshops on its own. Block printing has drawn interest from an unexpected direction too — a recent session welcomed an Israeli family learning the technique together.</p>
      <h2>What This Means for Corporate Teams Booking in Gurgaon and Delhi</h2>
      <p>For corporate teams, all three shifts point the same way: art workshops are being booked less as generic entertainment and more as a deliberate reset — personalized, unhurried, and increasingly tied to a real CSR or wellness goal. That's especially visible in Gurgaon, where Kraftykinni continues to see steady enquiry volume for corporate team-building sessions that run desk-side rather than needing a separate offsite venue.</p>
      <h2>Book a Workshop Built Around Where Craft Is Headed</h2>
      <p>Kraftykinni runs all of the formats mentioned here — Dot Mandala Art, personalized MDF magnets and trinket trays, eco-friendly clay idols, Lippan Art, and block printing — for corporate teams, schools, and private events across Delhi, Gurgaon, and Noida. Every session is led by Shramita Govil, a Fevicryl Certified Artist, with pricing starting at ₹600 per person for groups of 100+, ₹700 for 50–100, and ₹800 for 20–50, all materials included. WhatsApp +91 9599622210 to check availability.</p>
      <h2>Frequently Asked Questions</h2>
      <h3>What is trending in art and craft right now?</h3>
      <p>In 2026, three trends are driving most craft workshop bookings: personalization (custom photo magnets and named keepsakes over generic templates), slow and meditative formats like Dot Mandala Art over quick five-minute crafts, and eco-conscious materials such as natural clay idols and upcycled bottle art. Kraftykinni, a Delhi NCR art workshop studio, has run all three formats across corporate, school, and private bookings through 2026.</p>
      <h3>What are the most popular creative workshops in Delhi NCR right now?</h3>
      <p>Dot Mandala Art, personalized MDF photo-magnet workshops, and heritage crafts like Lippan Art and block printing are among the most-booked creative workshops in Delhi NCR in 2026, based on Kraftykinni's own session bookings.</p>
      <h3>Are DIY workshops still popular in Delhi NCR?</h3>
      <p>Yes. What has changed in 2026 is the format: participants increasingly prefer personalized, unhurried sessions like Dot Mandala Art or custom photo-magnet painting over quick generic craft activities.</p>
      <h3>What's a good corporate team-building activity trend in Gurgaon?</h3>
      <p>Desk-side or boardroom art workshops that double as a wellness reset are the strongest corporate team-building trend in Gurgaon right now — Dot Mandala Art in particular, since it needs no offsite venue and gives every participant a finished piece.</p>
      <h3>Does Kraftykinni use eco-friendly materials?</h3>
  ...
  {
    path: '/blog/corporate-diwali-celebration-ideas-delhi-ncr',
    title: 'Corporate Diwali Activities Delhi NCR 2026 | Kraftykinni',
    description: 'Planning a corporate Diwali celebration in Delhi, Gurgaon or Noida? 9 hands-on Diwali art activities, pricing, group-size guidance and how Kraftykinni runs them for 20-200+ employees.',
    h1: 'Corporate Diwali Celebration Ideas for Delhi NCR: 9 Creative Activities Employees Actually Enjoy',
    schemas: [
      {
        '@context': 'https://schema.org',
        '@type': 'BlogPosting',
        'headline': 'Corporate Diwali Celebration Ideas for Delhi NCR: 9 Creative Activities Employees Actually Enjoy',
        'description': 'Planning a corporate Diwali celebration in Delhi, Gurgaon or Noida? 9 hands-on Diwali art activities, pricing, group-size guidance and how Kraftykinni runs them for 20-200+ employees.',
        'url': 'https://kraftykinni.in/blog/corporate-diwali-celebration-ideas-delhi-ncr/',
        'datePublished': '2026-09-11',
        'dateModified': '2026-09-12',
        'author': { '@type': 'Person', 'name': 'Shramita Govil', 'url': 'https://kraftykinni.in/about/' },
        'publisher': { '@type': 'Organization', 'name': 'Kraftykinni', 'url': 'https://kraftykinni.in', 'logo': { '@type': 'ImageObject', 'url': 'https://cdn.kraftykinni.in/logo.jpeg' } },
        'mainEntityOfPage': { '@type': 'WebPage', '@id': 'https://kraftykinni.in/blog/corporate-diwali-celebration-ideas-delhi-ncr/' },
      },
    ],
    bodyContent: `<h1>Corporate Diwali Celebration Ideas for Delhi NCR: 9 Creative Activities Employees Actually Enjoy</h1>
      ...
      <h2>9 Corporate Diwali Art Activities for Employees</h2>
      <p>For most corporate teams, we recommend the Lippan Ganesha Canvas Art, Diya Painting or the Lippan Mirror Tealight Holder first — they combine easy participation with a genuinely useful take-home piece.</p>
      <h3>1. Lippan Ganesha Canvas Art</h3>
      <p>Our flagship Diwali format — a mirror-inlay Ganesha built on canvas using the Lippan Art technique from Kutch, Gujarat, set against a hand-blended festive background. 90–120 minutes, groups of 20–100.</p>
      <h3>2. Diya Painting</h3>
      <p>Our most-requested format — hand-painted clay diyas with acrylic colours, floral motifs and metallic detailing, using the Clay Art technique. 60–75 minutes, groups of 30–200+.</p>
      <h3>3. Diwali Jar Painting (Tealight Jars)</h3>
      <p>Employees hand-paint a stained-glass-style mosaic design onto a glass jar, using the Glass Painting technique, then fit it with a warm tealight for a group lights-on reveal. 75–90 minutes, groups of 20–150.</p>
      <h3>4. Lippan Mirror Tealight Holder</h3>
      <p>A round mirror-inlay plate built around a central tealight, using the Lippan Art technique. A premium alternative for offices that already ran diya painting last year. 75–90 minutes, groups of 20–100.</p>
      <h3>5. Lippan Mirror Décor Plate</h3>
      <p>A circular mandala of mirror pieces built up on a coloured base, using the Lippan Art technique in a faster, simpler format than the flagship canvas. 60–75 minutes, groups of 20–150.</p>
      <h3>6. Mini Lippan Art Wall Hanging</h3>
      <p>A small tasselled, mirror-inlay wall hanging using the Lippan Art technique in miniature — a lighter, more compact take-home piece for shorter time slots. 60–75 minutes, groups of 20–150.</p>
      <h3>7. Madhubani Art Coasters</h3>
      <p>Employees hand-paint a Madhubani folk-art design — elephants, fish and birds are popular motifs — onto a set of wooden coasters, a functional keepsake with a genuine cultural-heritage story. 60–90 minutes, groups of 20–150.</p>
      <h3>8. Shubh-Labh Hanging Basket</h3>
      <p>Employees paint a small jute-handled hanging basket with the traditional "Shubh" and "Labh" script and fill it with festive artificial flowers — one of Diwali's most recognisable auspicious phrases, symbolising good fortune and gain. 60–75 minutes, groups of 20–150.</p>
      <h3>9. Riddhi-Siddhi Hanging Basket</h3>
      <p>The same jute-handled hanging basket format, painted with "Riddhi" and "Siddhi" — the auspicious pairing for prosperity and spiritual accomplishment. Often run alongside the Shubh-Labh basket as a matching pair, or offered as a design choice. 60–75 minutes, groups of 20–150.</p>
      <h2>Which Diwali Activity Fits Your Team</h2>
      <p>20–40 employees: Lippan Ganesha Canvas Art or Lippan Mirror Tealight Holder. 50–100 employees: Diwali Jar Painting or Diya Painting. 100–200+ employees: Diya Painting, Madhubani Art Coasters or Mini Lippan Art Wall Hanging. Premium experience: Lippan Ganesha Canvas Art. Short 60-minute slot: Diya Painting or Mini Lippan Art Wall Hanging. Cultural/heritage angle: Madhubani Art Coasters. Auspicious festive symbolism: Shubh-Labh Hanging Basket or Riddhi-Siddhi Hanging Basket. Something different from last year: Diwali Jar Painting or Lippan Mirror Décor Plate.</p>
      <h2>What a Corporate Diwali Workshop Costs in Delhi NCR</h2>
      <p>Standard pricing is ₹800 per person for groups of 20–50, ₹700 for 50–100, and ₹600 for 100+, all materials included. Diwali-specific formats with mirror inlay work — the Lippan Ganesha Canvas Art and Lippan Mirror Tealight Holder — are typically priced toward the upper end of that range or slightly above it, depending on materials.</p>
      ...
      <p>Gurgaon: Cyber City, Udyog Vihar, Golf Course Road, Sohna Road, DLF Cyber Park — the Lippan Ganesha Canvas Art, Lippan Mirror Tealight Holder and Mini Lippan Art Wall Hanging work well for this MNC-heavy market. Noida: Sectors 62, 63, 135, 142, 16/18 — Diya Painting, Diwali Jar Painting and Madhubani Art Coasters suit Noida's larger, price-sensitive office events.</p>
      ...
      <p>Schools run diya painting or Madhubani coasters as a Diwali craft period. Cafés book jar painting or diya painting as a festive pop-up. Colleges book a live workshop stall for their annual Diwali Mela. Event managers book Kraftykinni as the craft-activity vendor for a client's Diwali event.</p>
      <h2>Get a Corporate Diwali Quote</h2>
      <p>Tell us your employee count, location, and preferred date, and we'll recommend a workshop that fits your team, timing and budget. WhatsApp +91 9599622210 with your details and which of the nine formats you'd like to run.</p>
      <h2>Frequently Asked Questions</h2>
      ...
      <p>The Lippan Ganesha Canvas Art, Diya Painting and the Lippan Mirror Tealight Holder are the top recommendations, combining easy participation with a genuinely useful take-home piece.</p>
      <h3>How much does a corporate Diwali art workshop cost?</h3>
      <p>₹800 per person for groups of 20–50, ₹700 for 50–100, and ₹600 for 100+, all materials included. Diwali-specific mirror-inlay formats sit toward the upper end of that range.</p>
      <h3>Which Diwali activity works best for 100+ employees?</h3>
      <p>Diya Painting, Madhubani Art Coasters, and the Mini Lippan Art Wall Hanging all scale comfortably to 100–300+ participants in a single session.</p>
      ...
      <h3>What is the difference between the Shubh-Labh and Riddhi-Siddhi hanging baskets?</h3>
      <p>Both use the same jute-handled hanging basket format and take a similar 60–75 minutes. The difference is the painted script and meaning — Shubh-Labh symbolises good fortune and gain, while Riddhi-Siddhi symbolises prosperity and spiritual accomplishment. Many offices run both so employees can pick a design.</p>
      <h3>Can the artwork be customised to our company colours or branding?</h3>
      <p>Yes, particularly the Lippan Ganesha Canvas Art and the hanging basket formats, where colours or the Hindi script can be adjusted. Other formats can include light branding on request.</p>
      <h3>How long does a corporate Diwali workshop take?</h3>
      <p>Most formats run 60 to 90 minutes. Diya Painting and the Mini Lippan Art Wall Hanging are fastest at 60–75 minutes; the Lippan Ganesha Canvas Art and Lippan Mirror Tealight Holder run closer to 90–120 minutes.</p>
      <h3>Do you run Diwali craft workshops for schools, cafés or colleges too?</h3>
      <p>Yes. Schools book diya painting or Madhubani coasters, cafés run festive pop-up sessions, and colleges book a live workshop stall for their annual Diwali Mela. Event managers can also book Kraftykinni as the craft-activity vendor for a client's Diwali event.</p>
    `,
  },

  {
    path: '/blog/navratri-tie-dye-trinket-tray-workshop-delhi-ncr',
    title: 'Navratri Workshop Ideas Delhi NCR 2026 | Kraftykinni',
    description: 'Navratri 2026 office and school workshop ideas: a 9-colours Tie & Dye session for corporate teams and a garba trinket tray for schools. Delhi, Gurgaon, Noida.',
    h1: 'Navratri 2026 Workshop Ideas — Tie & Dye "9 Colours" Sessions and Garba Trinket Trays in Delhi NCR',
    schemas: [
      {
        '@context': 'https://schema.org',
        '@type': 'BlogPosting',
        'headline': 'Navratri 2026 Workshop Ideas — Tie & Dye "9 Colours" Sessions and Garba Trinket Trays in Delhi NCR',
        'description': 'Navratri 2026 office and school workshop ideas: a 9-colours Tie & Dye session for corporate teams and a garba trinket tray for schools. Delhi, Gurgaon, Noida.',
        'url': 'https://kraftykinni.in/blog/navratri-tie-dye-trinket-tray-workshop-delhi-ncr/',
        'datePublished': '2026-09-25',
        'dateModified': '2026-09-25',
        'author': { '@type': 'Person', 'name': 'Shramita Govil', 'url': 'https://kraftykinni.in/about/' },
        'publisher': { '@type': 'Organization', 'name': 'Kraftykinni', 'url': 'https://kraftykinni.in', 'logo': { '@type': 'ImageObject', 'url': 'https://cdn.kraftykinni.in/logo.jpeg' } },
        'mainEntityOfPage': { '@type': 'WebPage', '@id': 'https://kraftykinni.in/blog/navratri-tie-dye-trinket-tray-workshop-delhi-ncr/' },
      },
    ],
    bodyContent: `<h1>Navratri 2026 Workshop Ideas — Tie & Dye "9 Colours" Sessions and Garba Trinket Trays in Delhi NCR</h1>
      <p>Most Delhi NCR offices already do some version of the "9 colours of Navratri" tradition — wearing the colour assigned to each of the nine days. Navratri Ghatasthapana falls on Sunday, 11 October 2026, and Kraftykinni is running two festival-timed workshops this year: a Tie & Dye session built around the 9-colours idea for corporate teams, and a garba-ready Trinket Tray for schools and private bookings, both variations of workshops Shramita Govil, a Fevicryl Certified Artist, runs year-round.</p>
      <h2>"9 Colours of Navratri" Tie & Dye — A Corporate Workshop</h2>
      <p>Using the regular Tie & Dye workshop format, participants fold, twist, and bind a plain t-shirt, tote bag, or dupatta before applying dye in that day's Navratri colour, so the take-home piece ties directly to the festival. Sessions run 1.5 to 2 hours and scale from 20 to 200+ participants.</p>
      <h2>Garba Trinket Tray — A Practical Take on Trinket Tray Painting</h2>
      <p>A themed version of the Trinket Tray Painting workshop. Participants paint a plain MDF tray with bold colours, mirror-work borders, or Navratri-colour patterns, creating somewhere for bangles and jewellery to land during garba and dandiya nights, and an everyday jewellery or desk tray afterward.</p>
      <h2>Why This Works for Offices and Schools</h2>
      <p>For offices, it replaces a passive colour-of-the-day tradition with an active one and photographs well for internal comms. For schools, a garba trinket tray session fits well as a pre-festival craft period and sends students home with something practical rather than a decoration.</p>
      <h2>Book a Navratri Workshop in Delhi NCR</h2>
      <p>Kraftykinni runs both workshops for corporate teams, schools, and private bookings across Delhi, Gurgaon, and Noida ahead of Navratri on 11 October 2026. Pricing starts at ₹600 per person for groups of 100+, ₹700 for 50–100, and ₹800 for groups of 20–50, all materials included. WhatsApp +91 9599622210 to book.</p>
      <h2>Frequently Asked Questions</h2>
      <h3>When is Navratri in 2026?</h3>
      <p>Navratri Ghatasthapana falls on Sunday, 11 October 2026. Booking a festival workshop two to three weeks ahead is recommended.</p>
      <h3>What is the "9 Colours of Navratri" Tie & Dye workshop?</h3>
      <p>A Navratri variation of the Tie & Dye workshop, where participants dye a t-shirt, tote bag, or dupatta in that day's assigned Navratri colour.</p>
      <h3>What is the Garba Trinket Tray workshop?</h3>
      <p>A themed version of the Trinket Tray Painting workshop — a hand-painted MDF tray to hold bangles and jewellery during garba and dandiya nights.</p>
      <h3>Is the Tie & Dye workshop suitable for large offices?</h3>
      <p>Yes. It scales from 20 to 200+ participants, runs 1.5 to 2 hours, and needs no prior experience.</p>
      <h3>How do I book a Navratri workshop before October 11?</h3>
...
// Same canonical social-profile list published in index.html's LocalBusiness
// sameAs — duplicated here (plain Node ESM can't import the .ts source of
// truth at src/data/siteConstants.ts) so every auto-generated schema below
// can link back to the same verified accounts.
const KRAFTYKINNI_SAME_AS = [
  'https://www.instagram.com/kraftykinni',
  'https://www.linkedin.com/in/kraftykinni/',
  'https://www.youtube.com/@kraftykinni',
  'https://in.pinterest.com/KraftyKinni/',
];

// Maps a route path to its breadcrumb label (+ optional parent path/name,
// defaulting to a direct Home > Page trail). Mirrors the BreadcrumbList
// already coded client-side in each page's <Helmet> (see src/pages/*.tsx),
// so non-JS crawlers see the same navigational trail as JS-rendering ones.
const BREADCRUMB_LABELS = {
  '/corporate-art-workshops': 'Corporate Art Workshops',
  '/school-art-workshops': 'School Workshops',
  ...
  '/workshops-in-delhi': 'Art Workshops in Delhi',
  '/workshops-in-gurgaon': 'Art Workshops in Gurgaon',
  '/workshops-in-noida': 'Art Workshops in Noida',
};

function buildBreadcrumbSchema(route, workshopData) {
  const routePath = route.path;
  const listItem = (position, name, itemPath) => ({
    '@type': 'ListItem', position, name, item: `https://kraftykinni.in${itemPath}`,
  });

  if (routePath === '/') {
    return {
      '@context': 'https://schema.org', '@type': 'BreadcrumbList',
      itemListElement: [listItem(1, 'Home', '/')],
    };
  }

  const trail = [listItem(1, 'Home', '/')];

  if (routePath.startsWith('/workshops/')) {
    trail.push(listItem(2, 'Workshops', '/corporate-art-workshops'));
    trail.push(listItem(3, workshopData?.title || route.h1, routePath));
  } else if (routePath.startsWith('/blog/')) {
    trail.push(listItem(2, 'Blog', '/blog'));
    trail.push(listItem(3, route.h1 || route.title, routePath));
  } else {
    const entry = BREADCRUMB_LABELS[routePath];
    if (!entry) return null; // no defined trail for this route — skip rather than guess
    if (typeof entry === 'string') {
      trail.push(listItem(2, entry, routePath));
    } else {
      trail.push(listItem(2, entry.parentName, entry.parentPath));
      trail.push(listItem(3, entry.name, routePath));
    }
  }
...
// Auto-parses an FAQPage schema straight out of a route's own visible
// bodyContent, so the schema can never drift out of sync with what a reader
// (or non-JS crawler) actually sees on the page. Handles both FAQ markup
// patterns used across routes: `<h3>Q</h3><p>A</p>` (corporate/school/
// private/location/employee-engagement pages) and `<details><summary>Q</summary><p>A</p></details>`
// (homepage). Returns [] when a page has no "Frequently Asked Questions" section.
function parseFaqFromBody(bodyContent) {
  if (!bodyContent) return [];
  const sectionMatch = bodyContent.match(/Frequently Asked Questions<\/h2>([\s\S]*?)(?:<h2|$)/);
  ...
  while ((m = detailsRe.exec(block)) !== null) {
    faqs.push({ q: stripTags(m[1]), a: stripTags(m[2]) });
  }
...
function injectMeta(html, route) {
  ...
  // Auto-parsed FAQPage schema for any route whose bodyContent has a visible
  // "Frequently Asked Questions" section but wasn't already covered by the
  // workshopData-driven branch above. Single source of truth = the visible
  // HTML, so schema and displayed text can never drift apart. Fixes the
  // audit finding of FAQPage schema missing on corporate/school/private/
  // location/employee-engagement pages.
  if (!workshopData?.faq?.length) {
    const parsedFaq = parseFaqFromBody(bodyContent);
    if (parsedFaq.length) {
      generatedSchemas.push({
        '@context': 'https://schema.org',
        '@type': 'FAQPage',
  ...
  // Breadcrumb trail — mirrors the client-side BreadcrumbList already coded
  // in each page's React <Helmet> (see src/pages/*.tsx) so non-JS crawlers
  // see the same navigational structure as JS-rendering ones.
  const breadcrumbSchema = buildBreadcrumbSchema(route, workshopData);
  if (breadcrumbSchema) generatedSchemas.push(breadcrumbSchema);

  // Article schema — gives every real content page citable-article metadata
  // (author, publisher, dates) for AI answer engines, unless it already ships
  // a more specific BlogPosting schema (blog posts) or is a noindex utility
  // page (/thank-you).
  if (!route.noindex && !(route.schemas || []).some((s) => s['@type'] === 'BlogPosting')) {
    generatedSchemas.push({
      '@context': 'https://schema.org',
      '@type': 'Article',
      ...
      image: ogImage || 'https://cdn.kraftykinni.in/logo.jpeg',
    });
  }
...
const sitemapEntries = [
  ...
  { loc: '/workshops/botanical-dyeing-printing', priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/rock-painting',       priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/umbrella-painting',   priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/cap-painting',        priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/canvas-pearl-art',    priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/clay-mirror-art',     priority: '0.7', changefreq: 'monthly' },
  { loc: '/workshops/mirror-painting',     priority: '0.7', changefreq: 'monthly' },
